...
export async function sendFriendRequest(receiverId: string) {
  try {
    ...
    // Send notification if supported (this uses the Web Notification API; you may need a native alternative)
...
export async function getProfileLinks(profileId: string) {
  try {
    ...
    if (isBusinessAccount) {
      // Use the SQL function to get followers with badges
      ...
      // Use the SQL function to get mutual friends with badges
